...
use crate::function::{
    check_file_exists, create_pretty_json, track_resource, value_to_bool, App, Value,
};
...
impl eframe::App for App {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        match &*self.page.clone() {
            "Launch" => {
                if !self.resource_page[0].change_page_updated {
            ...
            "Home" => {
                ...
                if !self.resource_page[1].change_page_updated {
                ...
                egui::CentralPanel::default().show(ctx, |ui| {
                    ...
                    egui::Window::new("Reg")
                        ...
                        .scroll(true)
                        .default_size(egui::Vec2::new(400_f32, 300_f32))
                        .fixed_pos(egui::Pos2::new(
                            ...
                            ui.vertical_centered(|ui| {
                                ...
                                ui.horizontal_centered(|ui| {
                                    if self.var_u("reg_status") == 0 {
                                        ...
                                        if ui.button(game_text["continue"][self.config.language as usize].clone()).clicked() {
                                            if !input3.replace(" ", "").replace("/", "").replace("\\", "").is_empty() {
                                                self.modify_var("reg_enable_name_error_message", false);
                                            } else {
                                                self.modify_var("reg_enable_name_error_message", true);
                                            };
                                            if input4 == input5 {
                                                ...
                                                self.modify_var("reg_enable_password_error_message", true);
                                            };
                                        };
            ...
            egui::TopBottomPanel::bottom("bottom_panel").show(ctx, |ui| {
                ui.horizontal_centered(|ui| {
                    ...
                    if ui.button("首页").clicked() {
                        self.resource_page[1].change_page_updated = false;
                        self.switch_page("Home");
                    };
                });
            });
